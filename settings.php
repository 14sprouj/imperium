...
<div class="w3-row">
	<div class="sw-fifth w3-bar-block w3-light-grey w3-card">
		<h4 class="w3-bar-item">Settings</h4>
		<button class="w3-bar-item w3-button tablink" onclick="opensettingCategory(event, 'Account')">Account</button>
		<button class="w3-bar-item w3-button tablink" onclick="opensettingCategory(event, 'Billing')">Billing</button>
		<button class="w3-bar-item w3-button tablink" onclick="opensettingCategory(event, 'Localisation')">Localisation</button>
		<button class="w3-bar-item w3-button tablink" onclick="opensettingCategory(event, 'Tokyo')">Tokyo</button>
	</div>
	<div class="sw-rest" style="margin-left:130px">
		<div id="Account" class="w3-container settingCategory" style="display:none">
			<h2>Account</h2>
			<h3>Change Password</h3>
			<form class="" action="try.php" method="post">
				<input type="hidden" name="formName" value="ChngPswd">
				<label>Current Password:</label> <input type="password" name="oldpsw">
				<br>
				<label>New Password</label>
				<input type="password" id="psw" name="newpsw" onkeyup="validate()" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required> <i id="showpsw"class="far fa-eye" onclick="pswShow()"></i>
				<div id="message">
				...
				<br>
				<label>Confirm Password</label><input type="password" id="cnfpsw" name="confirmpsw" onkeyup="match()">
				<span id="pswnotmatch" style="display:none;">Passwords do not match</span>
				<br>
				...
				function cnfpswShow() {
					if (cnfpsw.type === "password") {
						cnfpsw.type = "text";
					} else {
						cnfpsw.type = "password";
					}
				}
			</script>
		</form>
	...
	<div id="Billing" class="w3-container settingCategory" style="display:none">
		<h2>Billing</h2>
		<div class="row">
			<div class="col-75">
				<div class="container">
	...
	<div id="Localisation" class="w3-container settingCategory" style="display:none">
		<h2>Localisation</h2>
		<form class="" action="try.php" method="post">
	...
	<div id="Tokyo" class="w3-container settingCategory" style="display:none">
		<h2>Tokyo</h2>
...
<script>
function opensettingCategory(evt, settingCategory) {
	var i, x, tablinks;
	x = document.getElementsByClassName("settingCategory");
	...
	document.getElementById(settingCategory).style.display = "block";
	evt.currentTarget.className += " w3-red";
}
opensettingCategory(event, 'Account');
</script>
